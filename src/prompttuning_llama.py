...
with open("/clwork/zhidong/MLLM_confidence/hftoken", "r") as f:
    token = f.readline()
login(token=token)
os.environ['HF_HOME'] = '/clwork/zhidong/MLLM_confidence/cache'
...
with open('output_Llama-2-7b-chat-hf.tsv', 'w') as f:
